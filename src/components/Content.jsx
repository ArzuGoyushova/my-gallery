...
const Content = () => {
  ...
  const ideas = [
    ...
    link: "https://www.instagram.com/reel/DNio5eiIfFq/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==" },
    {
      text: "🧥 Əgər mən GAP marketinq komandasının bir üzvü olsaydım, “Zip the Sky” (Səmanı Kilidlə (zəncirbəndlə, zamokla)) adlı kampaniyanı təklif edərdim.\n\nPencəklər (jacket, kurtka) sadəcə havadan qorunmaq üçün deyil — onlar sənə təbiəti idarə etmək gücü verir. Bir hərəkətlə — pencəyin önünü bağlamaqla — mühit dəyişir. Soyuq da, isti də sənin seçimindir.\n\nİcra Planı\n\nVizual Hekayə\n\nKampaniyanın mərkəzində GAP-ın su keçirməz üst geyimlərində rəqqaslar dayanır. Onların hərəkətləri ilə səma dəyişir:Paltarın önü açıldıqca → qara buludlar toplanır, yağış yağır. Bağlandıqda → yağış dayanır.\n\nRəqs + Pop Mədəniyyəti\n\nGAP həmişə musiqi və rəqs mərkəzli kampaniyaları ilə yadda qalır. Bu dəfə də populyar simalarla iş birliyi edərək həm rəqs enerjisini, həm də qlobal cazibəni birləşdirmək olar:\n\nStep Up rəqqas komandası → güclü xoreoqrafiya, tanış və nostaljik enerji.\n\nTom Holland → Umbrella ifası ilə “yağış rəqsi” simvoluna çevrilib.\n\nBTS üzvü (məsələn, V) → beynəlxalq ulduz gücü və canlı vokal və rəqs performansı.\n\nYağış Səhnəsi\n\nƏsas səhnə güclü yağış altında çəkilir.\n\nMusiqi Seçimləri\n\nMusiqi GAP kampaniyalarının ruhudur. “Zip the Sky” üçün isə tanış və ya tamamilə yeni mahnılar seçilə bilər:\n\n“Umbrella” (Rihanna) → müasir versiya, Tom Holland-ın viral performansına işarə.\n\n“Rain over me” (Pitbull) → nostaljik lakin enerjili.\n\nV-dən tamamilə yeni bir mahnı.\n\nMesaj Nədir?\n\nGüc və azadlıq → Pencək sadəcə geyim deyil, mühiti idarə etmə imkanıdır.\n\nHərəkət → GAP pencəkləri sərbəst hərəkət üçün yaradılıb.\n\nMüasir nəsilə uyğunluq → İkonik mahnılar, məşhur rəqqaslar və qlobal ulduzlarla GAP pop mədəniyyətin mərkəzində qalır.\n\nVizual Effekt → Tək zəncirbənd hərəkəti ilə yağışın günəşə çevrilməsi — unudulmaz görüntü yaradır.\n\nNiyə bu kampaniya GAP üçün uyğundur?\n\nGAP-in musiqi və rəqs əsaslı kampaniya irsini davam etdirir.\n\nViral mədəniyyətə toxunur (yağış rəqsi, ikonik performanslar).\n\nPencəkləri sadəcə praktik geyim kimi deyil, özünəinam və üslub simvolu kimi təqdim edir.\n\nZip the Sky pencəkləri ikonikləşdirir — hava sənin əlindədir, səhnə sənin, an isə tamamilə sənindir.\n\n Əlavə olaraq, V bu kampaniyada iştirak edəcəyi halda, GAP sözündəki A hərfi V olaraq təqdim olunub, daha sonra çevrilib A olaraq göstərilə bilər.",
    },
  ];
