...
const academyChannels = [
 ...
 const schoolChannels = [
  ...
  {/* Top Half: Channels */}
  <div className="flex flex-col md:flex-row flex-wrap justify-center md:items-start items-center relative z-10 gap-8 px-4 md:px-8 py-6">
    {/* JET Academy */}
    <div className="flex flex-col md:flex-row items-center justify-around md:w-2/5">
      <div
  ...
  {/* Bottom Half */}
  <div className="flex flex-col lg:flex-row gap-8 px-4 md:px-8 py-4 relative z-10">
    {/* Captions panel */}
    <div className="flex-shrink-0 w-full lg:w-1/3 min-w-0 max-w-xl p-6">
        ...
        {captions.map((caption, i) => {
          ...
          return (
            <div key={i} className="paper relative">
              <p className="text-black/60 text-sm leading-snug line-clamp-3 pr-8">{text}</p>
      ...
      <div className="flex gap-4 overflow-x-auto pb-2">
        {videoData.map((video) => {
          ...
          return (
            ...
            >
              <img src={thumbnail} alt={video.title} className="w-full h-full object-cover block" />
              <button
