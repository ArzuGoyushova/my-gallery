...
const Hero = () => {
  ...
  <section
  id="home"
  className="w-[200vw] md:w-screen h-screen shrink-0 relative flex flex-row items-center justify-between px-6 md:ps-24 text-white"
>
  {/* Left: Wall Text */}
  ...
  <div className="w-1/2 relative flex flex-col items-center md:-mt-12 md:mb-0 flex-shrink-0">
